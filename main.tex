    ...
    \begin{chapter}{Homografies}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
                ...
                %Shape: Circle [id:dp8383721621718325] 
                \draw   (254,131.5) .. controls (254,93.67) and (284.67,63) .. (322.5,63) .. controls (360.33,63) and (391,93.67) .. (391,131.5) .. controls (391,169.33) and (360.33,200) .. (322.5,200) .. controls (284.67,200) and (254,169.33) .. (254,131.5) -- cycle ;
                %Curve Lines [id:da7214037578734126] 
                \draw  [dash pattern={on 4.5pt off 4.5pt}]  (322.5,63) .. controls (341.5,100) and (352.5,146) .. (322.5,200) ;
                %Curve Lines [id:da53708741098247] 
                \draw  [dash pattern={on 4.5pt off 4.5pt}]  (391,131.5) .. controls (383.5,155) and (303.5,161) .. (254,131.5) ;
               
                % Text Node
                \draw (318,52) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {$\displaystyle \infty $};
                % Text Node
                \draw (344,156) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {$\displaystyle i$};
                % Text Node
                \draw (241,134.5) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {$\displaystyle -1$};
                % Text Node
                \draw (393,134.5) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {$\displaystyle 1$};
                % Text Node
                \draw (324.5,203) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {$\displaystyle 0$};
            \end{tikzpicture}
...
\begin{proof} Veurem $(i)\iff(iii)\iff(iv)\iff(ii)$.
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
            ...
            % Text Node
            \draw (187.78,288.09) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize] [align=left] {
                $\displaystyle\begin{aligned} 
                    0\mapsfrom &w_{1}\\
                    \frac{w_{2} -w_{1}}{1-\overline{w_{1}} w_{2}} \mapsfrom &w_{2}
                \end{aligned}$};
            % Text Node
            ...
            % Text Node
            \draw (389,287.82) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {$ \frac{w_{2} -w_{1}}{1-\overline{w_{1}} w_{2}}$};
            % Text Node
